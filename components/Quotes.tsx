  ...
  return (
    <div className="space-y-6 animate-fade-in pb-20">
               ...
               <div className="flex justify-between items-start mb-6 pl-4">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                       ...
                       {quote.id === 'usd' && <span className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-[10px] font-bold px-1.5 py-0.5 rounded">LIVE</span>}
                    </div>
                    ...
                    <p className="text-xs text-gray-400 font-medium mt-1">Preço por {quote.unit}</p>
                  </div>
      ...
      <div className="bg-gray-50 dark:bg-slate-900 p-4 rounded-xl border border-gray-200 dark:border-slate-700 text-xs text-gray-500 dark:text-gray-400 flex items-start gap-2">
         ...
         <p>
           Os valores do Dólar são obtidos em tempo real via AwesomeAPI. 
           Os valores das commodities (Café, Soja, Milho) são <strong>estimativas de mercado</strong> simuladas para fins demonstrativos e não devem ser utilizados como única fonte para negociações reais. Consulte sua cooperativa local para valores exatos de balcão.
         </p>
      </div>
    </div>
  );
