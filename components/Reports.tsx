...
export const Reports: React.FC<ReportsProps> = ({ crop }) => {
  ...
  // --- Export PDF Logic (Stable Version) ---
  const generatePDF = () => {
    ...
    try {
        ...
        doc.text(`Relatório: ${reportType.toUpperCase()}`, 14, 70);
        ...
        doc.text(`Total Colhido: ${totalHarvested} sc`, 14, 92);
